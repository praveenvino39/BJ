...
class Erc20 extends i1.GeneratedContract {
  Erc20(
      {required i1.EthereumAddress address,
      required i1.Web3Client client,
      int? chainId})
  ...
  Future<BigInt> allowance(i1.EthereumAddress owner, i1.EthereumAddress spender,
  ...
  /// set by the contract.
  Future<String> approve(i1.EthereumAddress spender, BigInt amount,
      {required i1.Credentials credentials,
      i1.Transaction? transaction}) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> balanceOf(i1.EthereumAddress account,
      {i1.BlockNum? atBlock}) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> decimals({i1.BlockNum? atBlock}) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> totalSupply({i1.BlockNum? atBlock}) async {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> transfer(i1.EthereumAddress recipient, BigInt amount,
      {required i1.Credentials credentials,
      i1.Transaction? transaction}) async {
  ...
  Future<String> transferFrom(
      i1.EthereumAddress sender, i1.EthereumAddress recipient, BigInt amount,
      {required i1.Credentials credentials,
      i1.Transaction? transaction}) async {
  ...
  Stream<Approval> approvalEvents(
      {i1.BlockNum? fromBlock, i1.BlockNum? toBlock}) {
    final event = self.event('Approval');
    final filter = i1.FilterOptions.events(
...
class Approval {
  Approval(List<dynamic> response)
      : owner = (response[0] as i1.EthereumAddress),
        spender = (response[1] as i1.EthereumAddress),
        value = (response[2] as BigInt);

  final i1.EthereumAddress owner;

  final i1.EthereumAddress spender;
