          ...
          children: [
            ...
            Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border:
                        Border.all(width: 1, color: Colors.grey.withAlpha(70))),
            ...
            GridView.builder(
              ...
              itemBuilder: (context, index) => SizedBox(
                ...
                child: InkWell(
                  onTap: () {
                    setState(() {
                      if (!disabledWords.contains(widget.passpharse[index])) {
                        ...
                        var confirmIndex =
                            confirmPassPhrase.indexOf(widget.passpharse[index]);
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                          color:
                              disabledWords.contains(widget.passpharse[index])
