...
class ReceiverAddressSuggestionWidget extends StatefulWidget {
  ...
  @override
  State<ReceiverAddressSuggestionWidget> createState() =>
      _ReceiverAddressSuggestionWidgetState();
}

class _ReceiverAddressSuggestionWidgetState
    extends State<ReceiverAddressSuggestionWidget>
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: ((context, index) => Container(
                        ...
                        child: ListTile(
                          onTap: () {
                            widget.onAccountSelect(Provider.of<WalletProvider>(
                                    context,
                                    listen: false)
                                .wallets[index]
                                .wallet
