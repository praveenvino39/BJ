...
Widget testWrapper(Widget widget, {Cubit? mockProvider}) {
  return mockProvider != null
      ? BlocProvider.value(
          value: mockProvider,
          child: MaterialApp(
            home: widget,
...
class MockCreateWalletCubit extends Mock implements CreateWalletCubit {}

class MockCreateState extends Mock implements CreateWalletState {}
